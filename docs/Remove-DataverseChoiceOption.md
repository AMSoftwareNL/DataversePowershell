...
```
Remove-DataverseChoiceOption -OptionSet <String> -Value <Int32> [-Solution <String>] [-SharedTag <String>]
...
```
Remove-DataverseChoiceOption -Table <String> -Column <String> -Value <Int32> [-Solution <String>]
